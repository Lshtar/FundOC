...
#import "HXFNetWorkStatusManager.h"
#import "AppDelegate.h"
#import <SystemConfiguration/CaptiveNetwork.h>
#import <ifaddrs.h>
#import <arpa/inet.h>

@implementation HXFNetWorkStatusManager
...
{
    NSString *network = @"";
    switch ([[HXFReachability reachabilityForInternetConnection] currentReachabilityStatus]) {
        case NotReachable:
            network = @"NONE";
            break;
